...
class Inception2d(nn.Module):
    ...
    def __init__(self, in_channels, pool_features):
        ...
        self.branchA = BasicConv2d(in_channels, pool_features, False, kernel_size = (5,1), stride = 1, padding = (2,0))        
        self.branchB_1 = BasicConv2d(in_channels, pool_features, False, kernel_size = (11,1), stride = 1, padding = (5,0))
        self.branchB_2 = BasicConv2d(pool_features, pool_features, False,kernel_size = (11,1), stride = 1,  padding = (5,0))
        self.branchB_3 = BasicConv2d(pool_features, pool_features,False, kernel_size=(11,1),stride = 1,  padding = (5,0))
...
class Inception(nn.Module):
    ...
    def __init__(self, in_channels, pool_features, filter_size, pool_size):
        ...
        self.branchA = BasicConv2d(in_channels, pool_features, False, kernel_size = (filter_size[0],1), stride = 1, padding = (int((filter_size[0] - 1)/2),0))
        
        self.branchB_1 = BasicConv2d(in_channels, pool_features, False, kernel_size = (filter_size[1],1), stride = 1, padding = (int((filter_size[1] - 1)/2),0))
        
        self.branchB_2 = BasicConv2d(pool_features, pool_features, False, kernel_size = (filter_size[1],1), stride = 1,  padding = (int((filter_size[1] - 1)/2),0))
        
        self.branchB_3 = BasicConv2d(pool_features, pool_features, False, kernel_size = (filter_size[1],1), stride = 1,  padding = (int((filter_size[1] - 1)/2),0))
...
class Inception3(nn.Module):
    ...
    def __init__(self, in_channels, pool_features, filter_size, pool_size):
        ...
        self.branchA_1 = BasicConv2d(in_channels, pool_features, False, kernel_size = (filter_size[0],1), stride = 1, padding = (int((filter_size[0] - 1)/2),0))
        
        self.branchA_2 = BasicConv2d(pool_features, pool_features, False, kernel_size = (filter_size[0],1), stride = 1, padding = (int((filter_size[0] - 1)/2),0))
